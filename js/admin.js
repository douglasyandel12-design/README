        ...
        <div class="order-card" id="order-card-${order.id}">
            ...
            <div style="font-size: 0.9rem; line-height: 1.6;">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 5px;">
                    <strong style="color: #374151; text-transform: uppercase; font-size: 0.8rem; letter-spacing: 0.5px;">Detalles del Cliente</strong>
                    <button onclick="copyCustomerData('${order.id}')" style="background: #f3f4f6; border: 1px solid #d1d5db; padding: 4px 8px; border-radius: 4px; cursor: pointer; font-size: 0.75rem; color: #374151; font-weight: bold; transition: background 0.2s;">📋 Copiar Datos</button>
                </div>
            ...
            try {
                ...
                if (orderCard) {
                    ...
                    setTimeout(() => {
                        ...
                        if (document.getElementById('salesChart')) renderSalesChart(); // Actualizar gráfico de ventas
                    }, 300);
                }
